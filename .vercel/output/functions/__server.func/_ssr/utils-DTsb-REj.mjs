...
//#region node_modules/.nitro/vite/services/ssr/assets/utils-DTsb-REj.js
var site = {
	name: "Sureste Studio",
	short: "SURESTE",
...
var services = [
	{
		...
		title: "Wayfinding",
		kicker: "Orientación",
		summary: "Sistemas de orientación visual que guían a las personas de forma intuitiva a través del espacio.",
	...
	},
	{
		...
		summary: "Creatividad y función para una señalética única, coherente con la arquitectura y el clima de cada destino.",
	...
	},
	{
		...
		summary: "Fabricación de señalética de calidad, funcional y resistente, con un amplio abanico de materiales.",
	...
	},
	{
		...
		summary: "Equipos formados en carpintería, albañilería y herrería para un montaje preciso y seguro.",
	...
	},
	{
		...
		title: "Mantenimiento",
		kicker: "Permanencia",
		summary: "Programas preventivos para conservar el funcionamiento y la imagen de cada pieza instalada.",
...
var products = [
	{
		...
		text: "Volumen en cobre, bronce, acero y acrílico, con o sin iluminación halo."
	},
	{
		title: "Letreros luminosos",
		text: "Cajas de luz, front-lit y back-lit para fachada y porte-cochère."
	},
	{
		title: "Tótems y monumentos",
		text: "Piezas de llegada a escala arquitectónica, interior y exterior."
	},
	{
		title: "Señalética inclusiva",
		text: "Braille, alto relieve y contraste para una lectura universal."
	},
	{
		title: "Ambientación gráfica",
		text: "Muros, celosías y gran formato que extienden la identidad."
	},
	{
		title: "Numeración hotelera",
		text: "Habitaciones, suites y directorios con el mismo lenguaje."
	}
];
var projects = [
	{
		...
		story: "Para Palmar diseñamos una familia de letras corpóreas en cobre cepillado, una placa de llegada y la numeración de terrazas. El criterio: que el letrero se lea como parte de la arquitectura, no como un añadido. El cobre se oxida con el salitre del Caribe y gana carácter con las temporadas.",
		services: [
			"Diseño",
			"Producción",
			"Instalación"
	...
	},
	{
		...
		story: "Un recorrido de 180 metros con tres niveles y once locales. Resolvimos la orientación con directorios de piso, banderolas de cobre y una nomenclatura que el visitante aprende en el primer cruce. Menos personal de información, más tiempo de permanencia.",
		services: [
			"Wayfinding",
			"Diseño",
			"Producción",
	...
	},
	{
		...
		story: "En un recinto de salud la claridad no es estética: es cuidado. Definimos códigos de color por especialidad, placas táctiles y un muro directorio que se lee a diez metros. El cobre aparece como acento, nunca como ruido.",
		services: [
			"Wayfinding",
			"Diseño",
	...
	},
	{
		...
		story: "Un resort de playa necesitaba presencia desde la marina. Fabricamos letras de 1.4 m en cobre con halo LED e instalamos sobre cantera con anclajes químicos. Coordinación con obra civil, ventanas de marea y un punch list de 48 horas antes de soft opening.",
		services: [
			"Producción",
			"Instalación",
			"Mantenimiento"
...
var stats = [
	{
		value: "12",
		suffix: "+",
		label: "años de oficio en el sureste"
	},
	{
		value: "180",
		suffix: "+",
		label: "propiedades señalizadas"
	},
	{
		value: "4",
		suffix: "",
	...
	},
	{
		value: "1.2",
		suffix: "k",
		label: "m² de taller de producción"
	}
];
var sectors = [
	"Hotelería y resorts",
...
var testimonials = [
	{
		quote: "Entendieron el hotel como lo entiende un arquitecto. La señalética no compite con el espacio: lo completa.",
		name: "Mariana Solís",
		role: "Directora de diseño, Costa Norte"
	},
	{
		quote: "Pasamos de tres personas en información a un sistema que se explica solo. El directorio de Galería Brisa es ahora parte de la marca.",
		name: "Héctor Villareal",
		role: "Gerencia de operaciones, Cancún"
	},
	{
		quote: "Cobre, braille y madera en una clínica no es sencillo. Lo resolvieron con una calma que se siente en cada pasillo.",
...
//#endregion
export { products as a, sectors as c, stats as d, testimonials as f, processSteps as i, services as l, faqs as n, projectTypes as o, nav as r, projects as s, cn as t, site as u };
